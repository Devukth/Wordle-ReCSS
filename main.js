...
const dayOffset = ((((msOffset / 1000) / 60) / 60) / 24) + 1;
...
function getGuessNumber() { return Math.floor((guessGrid.querySelectorAll("[data-letter]").length) / 5); }

function showAlert(alertTxt, duration = 1000) {
...
function checkWinLose(guess, tiles) {
    if(guess == targetWord) {
        ...
        if(getGuessNumber() == 1) showAlert("Genius", 5000);
        if(getGuessNumber() == 2) showAlert("Magnificent", 5000);
        if(getGuessNumber() == 3) showAlert("Impressive", 5000);
        if(getGuessNumber() == 4) showAlert("Splendid", 5000);
        if(getGuessNumber() == 5) showAlert("Great", 5000);
        if(getGuessNumber() == 6) showAlert("Phew", 5000);
        danceTiles(tiles);
        stopInteraction();
        return;
    }
